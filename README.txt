...
Tags: GDPR, RGPD, form, data request, personal data request form, export
...
Integrates WordPress Core 4.9.6 GDPR tools to allow users/visitors to request Personal Data export/erasure with front-end forms.
...
2. Activate the plugin through the 'Plugins' menu in WordPress: That's all, there is no settings!
...
You need WordPress **4.9.6+** to use this plugin.
...
Please read this Make/Core post: https://wordpress.org/news/2018/05/wordpress-4-9-6-privacy-and-maintenance-release/ (English)
If you speak French, you can also read the post I wrote on Whodunit Agency Blog: https://www.whodunit.fr/wordpress-4-9-6-et-la-conformite-rgpd/ (French)
